...
Можно выбрать оптимальный выбор если будет что то лучше - можешь предложить
...
структура для примера эта - также можешь улучшить
---
...
ЕСЛИ ВИДИШЬ ОШИБКИ -  СООБЩИ, ВОЗМОЖНО ПЕРЕСТРОИМ ТЗ